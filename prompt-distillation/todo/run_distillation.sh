...
PROJECT_DIR="/fsx/users/wangzg/slm_distillation"
...
CONFIGS=(
    ...
    # Axis 1: LoRA rank sweep — does smaller adapter preserve base model ability?
    # "config/pipeline_lora_r128.yaml"
    # "config/pipeline_lora_r64.yaml"

    # # Axis 2: Token loss weight — does stronger direct supervision on NLP text help?
