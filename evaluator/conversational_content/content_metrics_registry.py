...
async def compute_all_metrics_batch(
    ...
    all_scores: List[Dict[str, Any]] = [{} for _ in range(len(ground_truths))]
    ...
    enabled_llm_judge_metrics = list(
        getattr(scoring_config, "llm_judge_metrics", []) or []
    )
